...
Javascript library implementing common utilities for hyperchain zkevm

[![Main CI](https://github.com/0xHyperChain/zkevm-commonjs/actions/workflows/main.yml/badge.svg)](https://github.com/0xHyperChain/zkevm-commonjs/actions/workflows/main.yml)

## Usage

```
const zkevmCommon = require("@0xhyperchain/zkevm-commonjs");
```
